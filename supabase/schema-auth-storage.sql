...
CREATE POLICY "authenticated_read" ON "storage"."objects" FOR SELECT TO "authenticated" USING (("bucket_id" = 'customer-documents'::"text"));



CREATE POLICY "authenticated_upload" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'customer-documents'::"text") AND (("storage"."foldername"("name"))[1] = 'documents'::"text")));
...
CREATE POLICY "portal_docs_customer_delete" ON "storage"."objects" FOR DELETE TO "authenticated" USING ((("bucket_id" = 'portal-documents'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "portal_docs_customer_read" ON "storage"."objects" FOR SELECT TO "authenticated" USING ((("bucket_id" = 'portal-documents'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "portal_docs_customer_upload" ON "storage"."objects" FOR INSERT TO "authenticated" WITH CHECK ((("bucket_id" = 'portal-documents'::"text") AND (("storage"."foldername"("name"))[1] = ("auth"."uid"())::"text")));



CREATE POLICY "portal_docs_service_all" ON "storage"."objects" TO "service_role" USING (("bucket_id" = 'portal-documents'::"text")) WITH CHECK (("bucket_id" = 'portal-documents'::"text"));
...
CREATE POLICY "service_role_all" ON "storage"."objects" TO "service_role" USING (("bucket_id" = 'customer-documents'::"text")) WITH CHECK (("bucket_id" = 'customer-documents'::"text"));
